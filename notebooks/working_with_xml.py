...
def extract_apnea_events(xml_file_path, output_csv=None):
    ...
    for event in root.findall('.//ns:Event', namespace):
        ...
        if (event_family == 'Respiratory' and 
            event_type in ['ObstructiveApnea', 'CentralApnea', 'MixedApnea', 'Hypopnea']):
...
if __name__ == "__main__":
    xml_path = "../sleep_audio_db/rml/00000999-100507.rml"
    
    # Extract apnea events
    events = extract_apnea_events(xml_path, "../sleep_audio_db/rml/00000999-100507.csv")
